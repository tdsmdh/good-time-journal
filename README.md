...
**TL;DR:** I needed a digital way to do the *Designing Your Life* "Good Time Journal", but the official app is discontinued. So, I used AI to build a free, private web app. It requires no account, saves locally, and syncs to your own Google Sheet. Links at the bottom!
...
* **Zero-Friction Logging & Editing:** Quickly log activities, employers/contexts, and AEIOU reflections. Made a typo or re-evaluated your energy? Seamlessly edit any past entry.
...
1. Visit the live site here: [https://tdsmdh.github.io/good-time-journal/](https://tdsmdh.github.io/good-time-journal/)
...
Want to use the app on your Mac and your iPhone seamlessly? You can plug in your own private Google Sheet to act as your free cloud database. This makes it incredibly easy to view or screenshot your data when doing the book's "Weekly Reflections" activity.
...
*⚠️ IMPORTANT UPDATE RULE: If you ever update the code in Apps Script, you MUST click Deploy -> Manage Deployments -> click the Pencil Icon -> select "New version" -> Deploy. Otherwise, your changes won't go live!*
...
Just copy and paste this into GitHub, make sure your two screenshot image files are uploaded exactly as named (`Good Time Journal - Desktop.png` and `Good Time Journal - Mobile.png`), and your repository page will look incredibly polished!
